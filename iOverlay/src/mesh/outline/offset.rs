...
mod tests {
    ...
    // Regression test for https://github.com/iShape-Rust/iOverlay/issues/61
    // Polygon with hole at UTM-scale coordinates triggers index out of bounds
    // in bind/solver.rs when ContourIndex::EMPTY is treated as a valid hole index.
    #[test]
    fn test_issue_61_hole_bind_panic() {
